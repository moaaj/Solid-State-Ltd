      ...
      <nav className="w-full fixed top-0 left-0 z-20 bg-white/60 backdrop-blur-lg shadow-lg border-b border-white/30">
        ...
        {menuOpen && (
          <div className="md:hidden bg-white/95 backdrop-blur border-t shadow-lg px-4 py-4 space-y-4 animate-fade-in">
            <Link to="/" className="block text-gray-800 hover:text-indigo-600 font-medium text-lg" onClick={() => setMenuOpen(false)}>Home</Link>
            <Link to="/contact" className="block text-gray-800 hover:text-indigo-600 font-medium text-lg" onClick={() => setMenuOpen(false)}>Contact</Link>
            <Link to="/completed" className="block text-gray-800 hover:text-indigo-600 font-medium text-lg" onClick={() => setMenuOpen(false)}>Handed-Over</Link>
          </div>
        )}
      </nav>
